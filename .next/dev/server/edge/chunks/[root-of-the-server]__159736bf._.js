...
function getCsrfCookieName() {
    return ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : CSRF_COOKIE_NAME_DEV;
}
 ...
 */ function getSupabaseEnv() {
    ...
    if (url.includes('your-supabase-url-here') || url.includes('placeholder') || anonKey.includes('your-supabase-anon-key-here') || anonKey.includes('placeholder')) {
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["logger"].error('Supabase environment variables contain placeholder values', {
    ...
    try {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["logger"].error('Invalid Supabase URL format', {
