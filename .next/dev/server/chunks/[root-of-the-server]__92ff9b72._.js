;!function(){try { var e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof global?global:"undefined"!=typeof window?window:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&((e._debugIds|| (e._debugIds={}))[n]="0abaeb04-ac6e-3c1d-b47b-5246a88fbffe")}catch(e){}}();
module.exports = [
...
"[project]/app/api/admin/list/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        const { page, pageSize } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2d$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["validatePagination"])(searchParams.get("page"), searchParams.get("pageSize"));
        ...
        let query = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseServer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseServer"].from("registration_meta").select("*", {
            count: "exact"
        });
        // Apply search filter (searches multiple columns)
        // Uses GIN indexes on team_name_normalized and org_name for fast text search
        if (q) {
            query = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2d$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["applySearchFilter"])(query, q, [
                "team_name",
                "org_name",
                "email_1",
                "team_code"
        ...
        query = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2d$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["applyPagination"])(query, page, pageSize);
        // Execute query with performance monitoring
        const { data, error, count: totalCount } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2d$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["executeQuery"])(async ()=>await query, "list_registrations", "registration_meta");
        if (error) {
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logger"].error("List query error:", error);
            throw __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ApiErrors"].badRequest(error.message);
        }
...
//# debugId=0abaeb04-ac6e-3c1d-b47b-5246a88fbffe
//# sourceMappingURL=%5Broot-of-the-server%5D__92ff9b72._.js.map